...
def calculateWriteOffDiremadi(dictMateriais, df):
            ...
            if key == material:
                try:
                    ...
                    for batch in list(dictMateriais[material]['Batch'].keys()):
                        if str(dictMateriais[material]['Batch'][batch].get('Storage location')) == '1005' and str(dictMateriais[material]['Batch'][batch].get('Plant')) == 'BR01':
